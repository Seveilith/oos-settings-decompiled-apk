  ...
  implements AnimatorProvider
{
    ...
    implements ValueAnimatorCompat
  {
    ...
    private Runnable mLoopRunnable = new Runnable()
    {
      public void run()
      {
        float f = (float)(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-wrap0(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this) - GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-get3(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this)) * 1.0F / (float)GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-get0(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this);
        if ((f > 1.0F) || (GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this.mTarget.getParent() == null)) {
          f = 1.0F;
        }
        GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-set0(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this, f);
        GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-wrap2(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this);
        if (GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-get1(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this) >= 1.0F)
        {
          GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-wrap1(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this);
          return;
        }
        GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this.mTarget.postDelayed(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.-get2(GingerbreadAnimatorCompatProvider.GingerbreadFloatValueAnimator.this), 16L);
      }
    };
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\animation\GingerbreadAnimatorCompatProvider.class
