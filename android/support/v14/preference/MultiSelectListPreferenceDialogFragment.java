    ...
    paramBuilder.setMultiChoiceItems(this.mEntries, arrayOfBoolean, new DialogInterface.OnMultiChoiceClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt, boolean paramAnonymousBoolean)
      {
        if (paramAnonymousBoolean)
        {
          ...
          MultiSelectListPreferenceDialogFragment.-set0(paramAnonymousDialogInterface, MultiSelectListPreferenceDialogFragment.-get2(paramAnonymousDialogInterface) | MultiSelectListPreferenceDialogFragment.-get1(MultiSelectListPreferenceDialogFragment.this).add(MultiSelectListPreferenceDialogFragment.-get0(MultiSelectListPreferenceDialogFragment.this)[paramAnonymousInt].toString()));
          return;
        }
        paramAnonymousDialogInterface = MultiSelectListPreferenceDialogFragment.this;
        MultiSelectListPreferenceDialogFragment.-set0(paramAnonymousDialogInterface, MultiSelectListPreferenceDialogFragment.-get2(paramAnonymousDialogInterface) | MultiSelectListPreferenceDialogFragment.-get1(MultiSelectListPreferenceDialogFragment.this).remove(MultiSelectListPreferenceDialogFragment.-get0(MultiSelectListPreferenceDialogFragment.this)[paramAnonymousInt].toString()));
      }
    });
  }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v14\preference\MultiSelectListPreferenceDialogFragment.class
