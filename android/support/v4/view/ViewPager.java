  ...
  extends ViewGroup
{
  ...
  private boolean isGutterDrag(float paramFloat1, float paramFloat2)
  {
    ...
    while ((paramFloat1 > getWidth() - this.mGutterSize) && (paramFloat2 < 0.0F)) {
      return true;
    }
    return false;
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if ((i == 0) || ((i == 1) && (this.mAdapter != null) && (this.mAdapter.getCount() > 1)))
    {
      ...
      if (!this.mLeftEdge.isFinished())
      {
        ...
        bool1 = this.mLeftEdge.draw(paramCanvas);
      ...
      if (!this.mRightEdge.isFinished())
      {
        ...
        this.mRightEdge.setSize(k - m - n, j);
        bool2 = bool1 | this.mRightEdge.draw(paramCanvas);
        paramCanvas.restoreToCount(i);
      }
    }
    for (;;)
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      for (f1 = this.mInitialMotionX + this.mTouchSlop;; f1 = this.mInitialMotionX - this.mTouchSlop)
      {
        ...
        bool1 = performDrag(paramMotionEvent.getX(paramMotionEvent.findPointerIndex(this.mActivePointerId)));
        break;
      }
      bool1 = bool2;
      if (this.mIsBeingDragged)
  ...
  void smoothScrollTo(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt3 > 0) {}
    for (paramInt1 = Math.round(Math.abs((f1 + f2 * f3) / paramInt3) * 1000.0F) * 4;; paramInt1 = (int)((1.0F + Math.abs(k) / (this.mPageMargin + f1 * f2)) * 100.0F))
    {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\view\ViewPager.class
