  ...
  implements ActionBarOverlayLayout.ActionBarVisibilityCallback
{
  ...
  private void init(View paramView)
  {
    ...
    while (this.mContainerView == null) {
    ...
    if ((this.mDecorToolbar.getDisplayOptions() & 0x4) != 0)
    {
      ...
      if (paramView.enableHomeButtonByDefault()) {
        break label260;
      }
    }
    for (;;)
  ...
  public void removeTabAt(int paramInt)
  {
    ...
    if (this.mSelectedTab != null) {}
    for (int i = this.mSelectedTab.getPosition();; i = this.mSavedTabPosition)
    {
  ...
  public void selectTab(ActionBar.Tab paramTab)
  {
    ...
    {
      if (paramTab != null) {}
      for (i = paramTab.getPosition();; i = -1)
      {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\app\WindowDecorActionBar.class
