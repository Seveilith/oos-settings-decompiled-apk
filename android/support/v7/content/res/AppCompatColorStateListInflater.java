...
final class AppCompatColorStateListInflater
{
    ...
    throws XmlPullParserException, IOException
  {
    ...
    for (;;)
    {
      ...
      if ((i == 2) && (k <= i1) && (paramXmlPullParser.getName().equals("item")))
      {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\content\res\AppCompatColorStateListInflater.class
