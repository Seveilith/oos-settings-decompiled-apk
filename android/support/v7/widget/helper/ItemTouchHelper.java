  ...
  implements RecyclerView.OnChildAttachStateChangeListener
{
  ...
  void postDispatchSwipe(final RecoverAnimation paramRecoverAnimation, final int paramInt)
  {
    this.mRecyclerView.post(new Runnable()
    {
      public void run()
      {
        if ((ItemTouchHelper.this.mRecyclerView == null) || (!ItemTouchHelper.this.mRecyclerView.isAttachedToWindow()) || (paramRecoverAnimation.mOverridden)) {}
        ...
        while (ItemTouchHelper.this.hasRunningRecoverAnim())
        {
        ...
        if (k == 2)
        {
          ...
          localObject = new RecoverAnimation(this, (RecyclerView.ViewHolder)localObject, i, k, f3, f4, f1, f2)
          {
            public void onAnimationEnd(ValueAnimatorCompat paramAnonymousValueAnimatorCompat)
            {
              ...
              if (j <= 0) {
                jdField_this.mCallback.clearView(jdField_this.mRecyclerView, localObject);
              }
              for (;;)
              {
                if (jdField_this.mOverdrawChild == localObject.itemView) {
                  jdField_this.removeChildDrawingOrderCallbackIfNecessary(localObject.itemView);
                }
                return;
                jdField_this.mPendingCleanup.add(localObject.itemView);
                this.mIsPendingCleanup = true;
                if (j > 0) {
                  jdField_this.postDispatchSwipe(this, j);
                }
              }
            }
          };
...
/* Location:              C:\Users\johan\Desktop\classes2-dex2jar.jar!\android\support\v7\widget\helper\ItemTouchHelper.class
