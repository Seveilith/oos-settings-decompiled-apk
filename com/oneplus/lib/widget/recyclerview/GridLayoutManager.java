  ...
  extends LinearLayoutManager
{
  ...
  private void assignSpans(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      LayoutParams.-set1(localLayoutParams, getSpanSize(paramRecycler, paramState, getPosition(localView)));
      if ((k != -1) || (LayoutParams.-get1(localLayoutParams) <= 1)) {
        break label159;
      }
      LayoutParams.-set0(localLayoutParams, paramInt2 - (LayoutParams.-get1(localLayoutParams) - 1));
    }
    for (;;)
    {
      paramInt2 += LayoutParams.-get1(localLayoutParams) * k;
      paramInt1 += i;
      break label43;
      paramInt1 -= 1;
      j = -1;
      ...
      break label43;
      label159:
      LayoutParams.-set0(localLayoutParams, paramInt2);
    }
  }
  ...
  {
    if ((this.mCachedBorders == null) || (this.mCachedBorders.length != this.mSpanCount + 1)) {}
    for (;;)
    {
      ...
      } while (this.mCachedBorders[(this.mCachedBorders.length - 1)] == paramInt);
    }
  }
  ...
  void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LinearLayoutManager.LayoutState paramLayoutState, LinearLayoutManager.LayoutChunkResult paramLayoutChunkResult)
  {
    ...
    if (j < n)
    {
      ...
      if (paramLayoutState.mScrapList == null) {
        if (bool)
        {
          ...
          k = View.MeasureSpec.makeMeasureSpec(this.mCachedBorders[(LayoutParams.-get0(paramState) + LayoutParams.-get1(paramState))] - this.mCachedBorders[LayoutParams.-get0(paramState)], 1073741824);
          if (this.mOrientation != 1) {
            break label422;
          }
    ...
    if (j < n)
    {
      ...
      {
        paramState = (LayoutParams)paramRecycler.getLayoutParams();
        m = View.MeasureSpec.makeMeasureSpec(this.mCachedBorders[(LayoutParams.-get0(paramState) + LayoutParams.-get1(paramState))] - this.mCachedBorders[LayoutParams.-get0(paramState)], 1073741824);
        if (this.mOrientation != 1) {
          break label546;
        }
    ...
    if (this.mOrientation == 1) {
      if (paramLayoutState.mLayoutDirection == -1)
      {
        ...
        m = getPaddingLeft() + this.mCachedBorders[LayoutParams.-get0(paramState)];
    ...
    for (;;)
    {
      ...
      break;
      label827:
      i1 = getPaddingTop() + this.mCachedBorders[LayoutParams.-get0(paramState)];
  ...
  public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, View paramView, AccessibilityNodeInfo paramAccessibilityNodeInfo)
  {
    ...
    if (this.mOrientation == 0)
    {
      ...
      {
        paramAccessibilityNodeInfo.setCollectionItemInfo(AccessibilityNodeInfo.CollectionItemInfo.obtain(j, k, i, 1, bool, false));
        return;
      }
    }
    ...
    {
      paramAccessibilityNodeInfo.setCollectionItemInfo(AccessibilityNodeInfo.CollectionItemInfo.obtain(i, 1, j, k, bool, false));
      return;
    }
  }
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\lib\widget\recyclerview\GridLayoutManager.class
