  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        ...
        return true;
      } while ((Math.abs(f1 - this.mInitialMotionX) <= this.mTouchSlop) && (Math.abs(f2 - this.mInitialMotionY) <= this.mTouchSlop));
    ...
    } while (f1 <= this.mCurrText.getRight() + this.mTabPadding);
    this.mPager.setCurrentItem(this.mPager.getCurrentItem() + 1);
    return true;
  }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\view\PagerTabStrip.class
