  ...
  implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener
{
  ...
  private View findParentViewForSubmenu(@NonNull CascadingMenuInfo paramCascadingMenuInfo, @NonNull MenuBuilder paramMenuBuilder)
  {
    ...
    label113:
    int i = k + j - localListView.getFirstVisiblePosition();
  ...
  public boolean isShowing()
  {
    boolean bool = false;
    if (this.mShowingMenus.size() > 0) {
      bool = ((CascadingMenuInfo)this.mShowingMenus.get(0)).window.isShowing();
    }
    return bool;
  }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\view\menu\CascadingMenuPopup.class
