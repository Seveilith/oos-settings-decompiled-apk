...
public class SortedList<T>
{
  ...
  public void updateItemAt(int paramInt, T paramT)
  {
    ...
    for (int i = 0; (localObject != paramT) && (this.mCallback.compare(localObject, paramT) == 0); i = 1)
    {
      this.mData[paramInt] = paramT;
      if (i != 0) {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\util\SortedList.class
