  ...
  extends BroadcastReceiver
{
  ...
  {
    if ((paramMediaSessionCompat == null) || (paramIntent == null)) {}
    while ((!"android.intent.action.MEDIA_BUTTON".equals(paramIntent.getAction())) || (!paramIntent.hasExtra("android.intent.extra.KEY_EVENT"))) {
      return null;
    }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\media\session\MediaButtonReceiver.class
