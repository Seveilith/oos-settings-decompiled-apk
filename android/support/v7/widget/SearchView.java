  ...
  implements CollapsibleActionView
{
  ...
  View.OnKeyListener mTextKeyListener = new View.OnKeyListener()
  {
    public boolean onKey(View paramAnonymousView, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
    {
      ...
      if ((!SearchView.SearchAutoComplete.-wrap0(SearchView.this.mSearchSrcTextView)) && (KeyEventCompat.hasNoModifiers(paramAnonymousKeyEvent)) && (paramAnonymousKeyEvent.getAction() == 1) && (paramAnonymousInt == 66))
      {
  ...
  private Intent createVoiceWebSearchIntent(Intent paramIntent, SearchableInfo paramSearchableInfo)
  {
    ...
    if (paramIntent == null) {}
    for (paramIntent = (Intent)localObject;; paramIntent = paramIntent.flattenToShortString())
    {
      localIntent.putExtra("calling_package", paramIntent);
      return localIntent;
    }
  ...
  private void updateSubmitButton(boolean paramBoolean)
  {
    ...
    if (this.mSubmitButtonEnabled)
    {
      ...
      if (isSubmitAreaEnabled())
      {
        i = j;
        if (hasFocus()) {
          if ((paramBoolean) || (!this.mVoiceButtonEnabled)) {
            break label52;
          }
        }
      }
  ...
  boolean onSuggestionsKey(View paramView, int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    if ((paramKeyEvent.getAction() == 0) && (KeyEventCompat.hasNoModifiers(paramKeyEvent)))
    {
      if ((paramInt == 66) || (paramInt == 84)) {}
      while (paramInt == 61) {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\widget\SearchView.class
