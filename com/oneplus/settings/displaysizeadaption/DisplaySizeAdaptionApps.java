...
public class DisplaySizeAdaptionApps
  extends ManageApplications
{
  public static final SummaryLoader.SummaryProviderFactory SUMMARY_PROVIDER_FACTORY = new SummaryLoader.SummaryProviderFactory()
  {
    ...
    {
      return new DisplaySizeAdaptionApps.SummaryProvider(paramAnonymousActivity, paramAnonymousSummaryLoader, null);
    }
  };
    ...
    public void setListening(boolean paramBoolean)
    {
      if (paramBoolean) {
        new AppCounter(this.mContext)
        {
          ...
          {
            return DisplaySizeAdaptionApps.SummaryProvider.-get0(DisplaySizeAdaptionApps.SummaryProvider.this).getNotificationsBanned(paramAnonymousApplicationInfo.packageName, paramAnonymousApplicationInfo.uid);
          }
          
          protected void onCountComplete(int paramAnonymousInt)
          {
            DisplaySizeAdaptionApps.SummaryProvider.-wrap0(DisplaySizeAdaptionApps.SummaryProvider.this, paramAnonymousInt);
          }
        }.execute(new Void[0]);
      }
    }
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\settings\displaysizeadaption\DisplaySizeAdaptionApps.class
