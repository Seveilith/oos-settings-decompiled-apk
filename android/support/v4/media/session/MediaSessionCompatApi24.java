...
class MediaSessionCompatApi24
{
  ...
  public static String getCallingPackage(Object paramObject)
  {
    ...
    try
    {
      paramObject = (String)((MediaSession)paramObject).getClass().getMethod("getCallingPackage", new Class[0]).invoke(paramObject, new Object[0]);
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\media\session\MediaSessionCompatApi24.class
