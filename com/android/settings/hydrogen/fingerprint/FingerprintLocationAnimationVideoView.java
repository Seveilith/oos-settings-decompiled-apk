  ...
  implements FingerprintFindSensorAnimation
{
  ...
  private static Uri resourceEntryToUri(Context paramContext, int paramInt)
  {
  ...
  protected void onFinishInflate()
  {
    ...
    setSurfaceTextureListener(new TextureView.SurfaceTextureListener()
    {
      public void onSurfaceTextureAvailable(SurfaceTexture paramAnonymousSurfaceTexture, int paramAnonymousInt1, int paramAnonymousInt2)
      {
        ...
        Uri localUri = FingerprintLocationAnimationVideoView.-wrap0(FingerprintLocationAnimationVideoView.-get0(FingerprintLocationAnimationVideoView.this), 2131296257);
...
/* Location:              C:\Users\johan\Desktop\classes2-dex2jar.jar!\com\android\settings\hydrogen\fingerprint\FingerprintLocationAnimationVideoView.class
