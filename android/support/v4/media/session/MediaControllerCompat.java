...
public final class MediaControllerCompat
{
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    public PlaybackStateCompat getPlaybackState()
    {
      ...
      if (localObject != null) {
        localPlaybackStateCompat = PlaybackStateCompat.fromPlaybackState(localObject);
      }
    ...
    public List<MediaSessionCompat.QueueItem> getQueue()
    {
      ...
      List localList2 = MediaControllerCompatApi21.getQueue(this.mControllerObj);
      if (localList2 != null) {
        localList1 = MediaSessionCompat.QueueItem.fromQueueItemList(localList2);
      }
      return localList1;
    }
    ...
    {
      MediaControllerCompat.TransportControlsApi21 localTransportControlsApi21 = null;
    ...
    {
      MediaControllerCompatApi21.registerCallback(this.mControllerObj, MediaControllerCompat.Callback.-get0(paramCallback), paramHandler);
    }
    ...
    {
      MediaControllerCompatApi21.unregisterCallback(this.mControllerObj, MediaControllerCompat.Callback.-get0(paramCallback));
    }
  }
    ...
    extends MediaControllerCompat.MediaControllerImplApi21
  {
    ...
    public MediaControllerCompat.TransportControls getTransportControls()
    {
      MediaControllerCompat.TransportControlsApi23 localTransportControlsApi23 = null;
      Object localObject = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
      if (localObject != null) {
    ...
    extends MediaControllerCompat.MediaControllerImplApi23
  {
    ...
    public MediaControllerCompat.TransportControls getTransportControls()
    {
      MediaControllerCompat.TransportControlsApi24 localTransportControlsApi24 = null;
      Object localObject = MediaControllerCompatApi21.getTransportControls(this.mControllerObj);
      if (localObject != null) {
    ...
    implements MediaControllerCompat.MediaControllerImpl
  {
    ...
    public void registerCallback(MediaControllerCompat.Callback paramCallback, Handler paramHandler)
    {
      ...
      try
      {
        ...
        this.mBinder.registerCallbackListener((IMediaControllerCallback)MediaControllerCompat.Callback.-get0(paramCallback));
        MediaControllerCompat.Callback.-wrap0(paramCallback, paramHandler);
    ...
    public void unregisterCallback(MediaControllerCompat.Callback paramCallback)
    {
      ...
      try
      {
        this.mBinder.unregisterCallbackListener((IMediaControllerCallback)MediaControllerCompat.Callback.-get0(paramCallback));
    ...
    extends MediaControllerCompat.TransportControls
  {
    ...
    public void setRating(RatingCompat paramRatingCompat)
    {
      ...
      if (paramRatingCompat != null) {
        localObject1 = paramRatingCompat.getRating();
      }
      MediaControllerCompatApi21.TransportControls.setRating(localObject2, localObject1);
    }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\media\session\MediaControllerCompat.class
