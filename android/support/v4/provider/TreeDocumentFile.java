  ...
  extends DocumentFile
{
  ...
  public DocumentFile createDirectory(String paramString)
  {
    ...
    if (localUri != null) {
      paramString = new TreeDocumentFile(this, this.mContext, localUri);
    }
    return paramString;
  }
  ...
  {
    Object localObject = null;
    paramString2 = DocumentsContractApi21.createFile(this.mContext, this.mUri, paramString1, paramString2);
    paramString1 = (String)localObject;
    if (paramString2 != null) {
      paramString1 = new TreeDocumentFile(this, this.mContext, paramString2);
    }
    return paramString1;
  }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\provider\TreeDocumentFile.class
