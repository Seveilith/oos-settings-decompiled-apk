...
public final class MediaBrowserCompat
{
    ...
    extends Handler
  {
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      while (this.mCallbackImplRef.get() == null) {
        return;
      }
    ...
    implements MediaBrowserCompat.MediaBrowserImpl, MediaBrowserCompat.MediaBrowserServiceCallbackImpl, MediaBrowserCompat.ConnectionCallback.ConnectionCallbackInternal
  {
    ...
    public MediaBrowserImplApi21(Context paramContext, ComponentName paramComponentName, MediaBrowserCompat.ConnectionCallback paramConnectionCallback, Bundle paramBundle)
    {
      ...
      if (paramBundle == null) {}
      for (paramBundle = localBundle;; paramBundle = new Bundle(paramBundle))
      {
    ...
    public void subscribe(@NonNull String paramString, Bundle paramBundle, @NonNull MediaBrowserCompat.SubscriptionCallback paramSubscriptionCallback)
    {
      ...
      MediaBrowserCompat.SubscriptionCallback.-wrap0(paramSubscriptionCallback, localSubscription1);
      localSubscription1.putCallback(paramBundle, paramSubscriptionCallback);
      if (this.mServiceBinderWrapper == null)
      {
        MediaBrowserCompatApi21.subscribe(this.mBrowserObj, paramString, MediaBrowserCompat.SubscriptionCallback.-get0(paramSubscriptionCallback));
        return;
      }
      try
      {
        this.mServiceBinderWrapper.addSubscription(paramString, MediaBrowserCompat.SubscriptionCallback.-get1(paramSubscriptionCallback), paramBundle, this.mCallbacksMessenger);
        return;
      }
        ...
        if (localList1.size() == 0)
        {
          ...
          else
          {
            ...
            while (i >= 0)
            {
              ...
              {
                this.mServiceBinderWrapper.removeSubscription(paramString, MediaBrowserCompat.SubscriptionCallback.-get1(paramSubscriptionCallback), this.mCallbacksMessenger);
                localList2.remove(i);
                localList3.remove(i);
              }
              i -= 1;
    ...
    extends MediaBrowserCompat.MediaBrowserImplApi23
  {
    ...
    public void subscribe(@NonNull String paramString, @NonNull Bundle paramBundle, @NonNull MediaBrowserCompat.SubscriptionCallback paramSubscriptionCallback)
    {
      ...
      MediaBrowserCompatApi24.subscribe(this.mBrowserObj, paramString, paramBundle, MediaBrowserCompat.SubscriptionCallback.-get0(paramSubscriptionCallback));
    }
    ...
    public void unsubscribe(@NonNull String paramString, MediaBrowserCompat.SubscriptionCallback paramSubscriptionCallback)
    {
      ...
      MediaBrowserCompatApi24.unsubscribe(this.mBrowserObj, paramString, MediaBrowserCompat.SubscriptionCallback.-get0(paramSubscriptionCallback));
    }
  }
    ...
    public void onServiceConnected(Messenger paramMessenger, String paramString, MediaSessionCompat.Token paramToken, Bundle paramBundle)
    {
      ...
      try
      {
        ...
        while (paramMessenger.hasNext())
        {
          ...
          {
            this.mServiceBinderWrapper.addSubscription(paramString, MediaBrowserCompat.SubscriptionCallback.-get1((MediaBrowserCompat.SubscriptionCallback)paramToken.get(i)), (Bundle)paramBundle.get(i), this.mCallbacksMessenger);
            i += 1;
          }
        }
        return;
