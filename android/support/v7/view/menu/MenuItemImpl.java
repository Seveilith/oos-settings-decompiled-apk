  ...
  implements SupportMenuItem
{
  ...
  public CharSequence getTitleCondensed()
  {
    ...
    for (CharSequence localCharSequence = this.mTitleCondensed; (Build.VERSION.SDK_INT >= 18) || (localCharSequence == null) || ((localCharSequence instanceof String)); localCharSequence = this.mTitle) {
  ...
  public boolean isVisible()
  {
    ...
    if ((this.mActionProvider != null) && (this.mActionProvider.overridesItemVisibility()))
    {
      if ((this.mFlags & 0x8) == 0) {
        bool1 = this.mActionProvider.isVisible();
      }
      return bool1;
    }
    bool1 = bool2;
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\view\menu\MenuItemImpl.class
