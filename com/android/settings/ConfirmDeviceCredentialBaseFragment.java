...
public abstract class ConfirmDeviceCredentialBaseFragment
  ...
  implements FingerprintUiHelper.Callback
{
  ...
  {
    if ((this.mReturnCredentials) || (!getActivity().getIntent().getBooleanExtra("com.android.settings.ConfirmCredentials.allowFpAuthentication", false)) || (isFingerprintDisallowedByStrongAuth())) {}
  ...
  {
    return (!this.mLockPatternUtils.isFingerprintAllowedForUser(this.mEffectiveUserId)) || (!this.mUserManager.isUserUnlocked(this.mUserId));
  }
  ...
  protected boolean isProfileChallenge()
  {
    ...
    return Utils.isManagedProfile(UserManager.get(localContext), this.mEffectiveUserId);
  }
  ...
  public void onViewCreated(View paramView, Bundle paramBundle)
  {
    ...
    getActivity().getIntent().getBooleanExtra("com.android.settings.ConfirmCredentials.showCancelButton", false);
    ...
    int i = Utils.getCredentialOwnerUserId(getActivity(), Utils.getUserIdFromBundle(getActivity(), getActivity().getIntent().getExtras()));
...
/* Location:              C:\Users\johan\Desktop\classes2-dex2jar.jar!\com\android\settings\ConfirmDeviceCredentialBaseFragment.class
