...
class MediaBrowserServiceCompatApi24
{
  ...
  static class ResultWrapper
  {
    ...
    public void sendResult(List<Parcel> paramList, int paramInt)
    {
      try
      {
        MediaBrowserServiceCompatApi24.-get0().setInt(this.mResultObj, paramInt);
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\media\MediaBrowserServiceCompatApi24.class
