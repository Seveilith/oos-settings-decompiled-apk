  ...
  implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment
{
  ...
  private void scrollToPreferenceInternal(final Preference paramPreference, final String paramString)
  {
    paramPreference = new Runnable()
    {
      public void run()
      {
        RecyclerView.Adapter localAdapter = PreferenceFragment.-get0(PreferenceFragment.this).getAdapter();
        ...
        {
          PreferenceFragment.-get0(PreferenceFragment.this).scrollToPosition(i);
          return;
        }
        localAdapter.registerAdapterDataObserver(new PreferenceFragment.ScrollToPreferenceObserver(localAdapter, PreferenceFragment.-get0(PreferenceFragment.this), paramPreference, paramString));
      }
    };
    if (this.mList == null)
    {
    ...
    extends RecyclerView.ItemDecoration
  {
    ...
    public void setDivider(Drawable paramDrawable)
    {
      ...
      for (this.mDividerHeight = paramDrawable.getIntrinsicHeight();; this.mDividerHeight = 0)
      {
        ...
        PreferenceFragment.-get0(PreferenceFragment.this).invalidateItemDecorations();
        return;
      }
    }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v14\preference\PreferenceFragment.class
