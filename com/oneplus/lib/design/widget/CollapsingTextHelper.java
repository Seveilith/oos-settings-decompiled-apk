...
final class CollapsingTextHelper
{
  ...
  private void calculateUsingTextSize(float paramFloat)
  {
    ...
    if (isClose(paramFloat, this.mCollapsedTextSize))
    {
      ...
      j = i;
      if (paramFloat > 0.0F) {
        if ((this.mCurrentTextSize != f1) || (this.mBoundsChanged)) {
          break label326;
        }
      }
    }
  ...
  private static float lerp(float paramFloat1, float paramFloat2, float paramFloat3, Interpolator paramInterpolator)
  {
    ...
    return Utils.lerp(paramFloat1, paramFloat2, f);
  }
  ...
  private static boolean rectEquals(Rect paramRect, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    if (paramRect.left == paramInt1)
    {
      bool1 = bool2;
      if (paramRect.top == paramInt2)
      {
        bool1 = bool2;
        if (paramRect.right == paramInt3)
        {
          bool1 = bool2;
          if (paramRect.bottom == paramInt4) {
            bool1 = true;
          }
        }
      }
  ...
  final boolean isStateful()
  {
    if ((this.mCollapsedTextColor == null) || (!this.mCollapsedTextColor.isStateful()))
    {
      if (this.mExpandedTextColor != null) {
        return this.mExpandedTextColor.isStateful();
      }
    }
    else {
      return true;
  ...
  {
    TypedArray localTypedArray = this.mView.getContext().obtainStyledAttributes(paramInt, R.styleable.OpTextAppearance);
    if (localTypedArray.hasValue(R.styleable.OpTextAppearance_android_textColor)) {
      this.mCollapsedTextColor = localTypedArray.getColorStateList(R.styleable.OpTextAppearance_android_textColor);
    }
    if (localTypedArray.hasValue(R.styleable.OpTextAppearance_android_textSize)) {
      this.mCollapsedTextSize = localTypedArray.getDimensionPixelSize(R.styleable.OpTextAppearance_android_textSize, (int)this.mCollapsedTextSize);
    }
    this.mCollapsedShadowColor = localTypedArray.getInt(R.styleable.OpTextAppearance_android_shadowColor, 0);
    this.mCollapsedShadowDx = localTypedArray.getFloat(R.styleable.OpTextAppearance_android_shadowDx, 0.0F);
    this.mCollapsedShadowDy = localTypedArray.getFloat(R.styleable.OpTextAppearance_android_shadowDy, 0.0F);
    this.mCollapsedShadowRadius = localTypedArray.getFloat(R.styleable.OpTextAppearance_android_shadowRadius, 0.0F);
    localTypedArray.recycle();
  ...
  void setExpandedTextAppearance(int paramInt)
  {
    TypedArray localTypedArray = this.mView.getContext().obtainStyledAttributes(paramInt, R.styleable.OpTextAppearance);
    if (localTypedArray.hasValue(R.styleable.OpTextAppearance_android_textColor)) {
      this.mExpandedTextColor = localTypedArray.getColorStateList(R.styleable.OpTextAppearance_android_textColor);
    }
    if (localTypedArray.hasValue(R.styleable.OpTextAppearance_android_textSize)) {
      this.mExpandedTextSize = localTypedArray.getDimensionPixelSize(R.styleable.OpTextAppearance_android_textSize, (int)this.mExpandedTextSize);
    }
    this.mExpandedShadowColor = localTypedArray.getInt(R.styleable.OpTextAppearance_android_shadowColor, 0);
    this.mExpandedShadowDx = localTypedArray.getFloat(R.styleable.OpTextAppearance_android_shadowDx, 0.0F);
    this.mExpandedShadowDy = localTypedArray.getFloat(R.styleable.OpTextAppearance_android_shadowDy, 0.0F);
    this.mExpandedShadowRadius = localTypedArray.getFloat(R.styleable.OpTextAppearance_android_shadowRadius, 0.0F);
    localTypedArray.recycle();
    if (Build.VERSION.SDK_INT >= 16) {
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\lib\design\widget\CollapsingTextHelper.class
