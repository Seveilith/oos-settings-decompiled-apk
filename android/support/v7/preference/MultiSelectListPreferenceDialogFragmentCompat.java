    ...
    paramBuilder.setMultiChoiceItems(this.mEntries, arrayOfBoolean, new DialogInterface.OnMultiChoiceClickListener()
    {
      public void onClick(DialogInterface paramAnonymousDialogInterface, int paramAnonymousInt, boolean paramAnonymousBoolean)
      {
        if (paramAnonymousBoolean)
        {
          ...
          MultiSelectListPreferenceDialogFragmentCompat.-set0(paramAnonymousDialogInterface, MultiSelectListPreferenceDialogFragmentCompat.-get2(paramAnonymousDialogInterface) | MultiSelectListPreferenceDialogFragmentCompat.-get1(MultiSelectListPreferenceDialogFragmentCompat.this).add(MultiSelectListPreferenceDialogFragmentCompat.-get0(MultiSelectListPreferenceDialogFragmentCompat.this)[paramAnonymousInt].toString()));
          return;
        }
        paramAnonymousDialogInterface = MultiSelectListPreferenceDialogFragmentCompat.this;
        MultiSelectListPreferenceDialogFragmentCompat.-set0(paramAnonymousDialogInterface, MultiSelectListPreferenceDialogFragmentCompat.-get2(paramAnonymousDialogInterface) | MultiSelectListPreferenceDialogFragmentCompat.-get1(MultiSelectListPreferenceDialogFragmentCompat.this).remove(MultiSelectListPreferenceDialogFragmentCompat.-get0(MultiSelectListPreferenceDialogFragmentCompat.this)[paramAnonymousInt].toString()));
      }
    });
  }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\preference\MultiSelectListPreferenceDialogFragmentCompat.class
