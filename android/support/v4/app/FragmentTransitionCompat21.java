        ...
        public boolean onPreDraw()
        {
          ...
          if (paramViewRetriever != null)
          {
            ...
            if (localView != null)
            {
              ...
              if (localTransition1 != null)
              {
                FragmentTransitionCompat21.-wrap1(paramArrayList1, localView);
          ...
          FragmentTransitionCompat21.-wrap2(paramObject3, localTransition1, paramArrayList1, true);
          return true;
        }
      });
      ...
      paramView1.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener()
      {
        public boolean onPreDraw()
        {
          ...
          if (paramObject1 != null)
          {
            ...
            FragmentTransitionCompat21.-wrap2(paramObject1, paramObject2, paramArrayList2, false);
            FragmentTransitionCompat21.-wrap2(paramObject1, paramObject3, paramArrayList3, false);
          }
          if (paramObject2 != null)
          {
            FragmentTransitionCompat21.removeTargets(paramObject2, paramArrayList2);
            FragmentTransitionCompat21.-wrap2(paramObject2, paramObject1, paramArrayList1, false);
            FragmentTransitionCompat21.-wrap2(paramObject2, paramObject3, paramArrayList3, false);
          }
      ...
      paramTransition.setEpicenterCallback(new Transition.EpicenterCallback()
      {
        ...
        public Rect onGetEpicenter(Transition paramAnonymousTransition)
        {
          if ((this.mEpicenter == null) && (this.val$epicenterView.epicenter != null)) {
            this.mEpicenter = FragmentTransitionCompat21.-wrap0(this.val$epicenterView.epicenter);
          }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\app\FragmentTransitionCompat21.class
