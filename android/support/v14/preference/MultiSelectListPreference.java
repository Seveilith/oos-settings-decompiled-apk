  ...
  extends AbstractMultiSelectListPreference
{
  ...
  protected Set<String> getPersistedStringSet(Set<String> paramSet)
  {
    ...
    return getPreferenceManager().getSharedPreferences().getStringSet(getKey(), paramSet);
  }
  ...
  protected boolean persistStringSet(Set<String> paramSet)
  {
    if (shouldPersist())
    {
      ...
      localEditor.putStringSet(getKey(), paramSet);
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v14\preference\MultiSelectListPreference.class
