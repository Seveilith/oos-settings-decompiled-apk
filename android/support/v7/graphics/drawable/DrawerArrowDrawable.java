  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    default: 
      if (DrawableCompat.getLayoutDirection(this) == 1)
      {
        ...
        float f2 = lerp(this.mBarLength, this.mArrowShaftLength, this.mProgress);
        ...
        j = 180;
        label151:
        f1 = lerp(f1, j, this.mProgress);
        float f4 = (float)Math.round(f5 * Math.cos(f6));
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\graphics\drawable\DrawerArrowDrawable.class
