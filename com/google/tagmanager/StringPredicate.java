  ...
  extends Predicate
{
  ...
  protected boolean evaluateNoDefaultValues(TypeSystem.Value paramValue1, TypeSystem.Value paramValue2, Map<String, TypeSystem.Value> paramMap)
  {
    ...
    if (paramValue1 == Types.getDefaultString()) {}
    while (paramValue2 == Types.getDefaultString()) {
      return false;
    }
...
/* Location:              C:\Users\johan\Desktop\classes2-dex2jar.jar!\com\google\tagmanager\StringPredicate.class
