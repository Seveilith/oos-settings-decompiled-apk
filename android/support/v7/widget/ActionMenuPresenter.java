  ...
  implements ActionProvider.SubUiVisibilityListener
{
  ...
  public boolean isOverflowMenuShowing()
  {
    if (this.mOverflowPopup != null) {
      return this.mOverflowPopup.isShowing();
    }
    return false;
  }
  ...
  public boolean showOverflowMenu()
  {
    ...
    while ((this.mMenu == null) || (this.mMenuView == null) || (this.mPostedOpenRunnable != null) || (this.mMenu.getNonActionItems().isEmpty())) {
      return false;
    }
    ...
    extends MenuPopupHelper
  {
    public ActionButtonSubmenu(Context paramContext, SubMenuBuilder paramSubMenuBuilder, View paramView)
    {
      ...
      label59:
      for (paramContext = (View)ActionMenuPresenter.-get1(ActionMenuPresenter.this);; paramContext = ActionMenuPresenter.this.mOverflowButton)
      {
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      if (ActionMenuPresenter.-get0(ActionMenuPresenter.this) != null) {
        ActionMenuPresenter.-get0(ActionMenuPresenter.this).changeMenuMode();
      }
      View localView = (View)ActionMenuPresenter.-get1(ActionMenuPresenter.this);
    ...
    extends MenuPopupHelper
  {
    ...
    {
      if (ActionMenuPresenter.-get0(ActionMenuPresenter.this) != null) {
        ActionMenuPresenter.-get0(ActionMenuPresenter.this).close();
      }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\widget\ActionMenuPresenter.class
