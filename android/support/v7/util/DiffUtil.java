...
public class DiffUtil
{
  ...
  public static class DiffResult
  {
    ...
    {
      DiffUtil.Snake localSnake = null;
      if (this.mSnakes.isEmpty()) {
        if ((localSnake != null) && (localSnake.x == 0)) {
          break label87;
        }
      }
      for (;;)
    ...
    private static DiffUtil.PostponedUpdate removePostponedUpdate(List<DiffUtil.PostponedUpdate> paramList, int paramInt, boolean paramBoolean)
    {
      ...
      while (i >= 0)
      {
        ...
        if ((localPostponedUpdate1.posInOwnerList == paramInt) && (localPostponedUpdate1.removal == paramBoolean))
        {
          ...
          {
            DiffUtil.PostponedUpdate localPostponedUpdate2 = (DiffUtil.PostponedUpdate)paramList.get(paramInt);
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\util\DiffUtil.class
