  ...
  public static class PathDataNode
  {
    ...
    private static void arcToBezier(Path paramPath, double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8, double paramDouble9)
    {
      ...
      while (i < j)
      {
        ...
        paramPath.rCubicTo((float)(paramDouble7 + paramDouble9 * paramDouble5) - (float)paramDouble7, (float)(paramDouble8 + paramDouble9 * paramDouble6) - (float)paramDouble8, (float)(d4 - paramDouble9 * d1) - (float)paramDouble7, (float)(d2 - paramDouble9 * d3) - (float)paramDouble8, (float)d4 - (float)paramDouble7, (float)d2 - (float)paramDouble8);
        paramDouble9 = d5;
        paramDouble7 = d4;
        paramDouble8 = d2;
        paramDouble5 = d1;
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\graphics\drawable\PathParser.class
