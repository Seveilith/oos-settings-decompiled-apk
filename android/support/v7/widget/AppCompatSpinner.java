    ...
    extends ListPopupWindow
  {
    ...
    boolean isVisibleToUser(View paramView)
    {
      if (ViewCompat.isAttachedToWindow(paramView)) {
        return paramView.getGlobalVisibleRect(this.mVisibleRect);
      }
      return false;
    }
      ...
      if (localViewTreeObserver != null)
      {
        final ViewTreeObserver.OnGlobalLayoutListener local2 = new ViewTreeObserver.OnGlobalLayoutListener()
        {
          public void onGlobalLayout()
          {
            ...
            AppCompatSpinner.DropdownPopup.-wrap0(AppCompatSpinner.DropdownPopup.this);
          }
        };
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\widget\AppCompatSpinner.class
