...
public class ViewDragHelper
{
  ...
  private boolean checkNewEdgeDrag(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2)
  {
    ...
    if (((this.mInitialEdgesTouched[paramInt1] & paramInt2) != paramInt2) || ((this.mTrackingEdges & paramInt2) == 0)) {}
    while (((this.mEdgeDragsLocked[paramInt1] & paramInt2) == paramInt2) || ((this.mEdgeDragsInProgress[paramInt1] & paramInt2) == paramInt2) || ((paramFloat1 <= this.mTouchSlop) && (paramFloat2 <= this.mTouchSlop))) {
      return false;
    }
  ...
  private int computeAxisDuration(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (paramInt2 > 0) {}
    for (paramInt1 = Math.round(Math.abs((f1 + f2 * f3) / paramInt2) * 1000.0F) * 4;; paramInt1 = (int)((Math.abs(paramInt1) / paramInt3 + 1.0F) * 256.0F)) {
  ...
  protected boolean canScroll(View paramView, boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBoolean)
    {
      if (!ViewCompat.canScrollHorizontally(paramView, -paramInt1)) {
        return ViewCompat.canScrollVertically(paramView, -paramInt2);
      }
      return true;
    }
    return false;
  ...
  public boolean isEdgeTouched(int paramInt1, int paramInt2)
  {
    ...
    {
      bool1 = bool2;
      if ((this.mInitialEdgesTouched[paramInt2] & paramInt1) != 0) {
        bool1 = true;
      }
    }
    return bool1;
            ...
            if ((this.mInitialMotionX != null) && (this.mInitialMotionY != null))
            {
              ...
              while (i < j)
              {
                ...
                else
                {
                  ...
                  int n = (int)f3;
                  n = this.mCallback.clampViewPositionHorizontal(localView, m + n, (int)f3);
                  int i1 = localView.getTop();
                  int i2 = (int)f4;
                  i2 = this.mCallback.clampViewPositionVertical(localView, i1 + i2, (int)f4);
                  int i3 = this.mCallback.getViewHorizontalDragRange(localView);
                  int i4 = this.mCallback.getViewVerticalDragRange(localView);
                  if (((i3 != 0) && ((i3 <= 0) || (n != m))) || ((i4 != 0) && ((i4 <= 0) || (i2 != i1)))) {
                    break label561;
                  }
                }
              }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\widget\ViewDragHelper.class
