  ...
  implements ItemTouchHelper.ViewDropHandler
{
  ...
  private boolean updateAnchorFromChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, AnchorInfo paramAnchorInfo)
  {
    ...
    if ((localView != null) && (AnchorInfo.-wrap0(paramAnchorInfo, localView, paramState)))
    {
  ...
  public View onFocusSearchFailed(View paramView, int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    ensureLayoutState();
    updateLayoutState(paramInt, (int)(this.mOrientationHelper.getTotalSpace() * 0.33F), false, paramState);
    this.mLayoutState.mScrollingOffset = Integer.MIN_VALUE;
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\lib\widget\recyclerview\LinearLayoutManager.class
