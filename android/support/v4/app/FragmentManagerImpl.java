    ...
    if (Build.VERSION.SDK_INT >= 19)
    {
      ...
      if (ViewCompat.getLayerType(paramView) == 0)
      {
        ...
        if (ViewCompat.hasOverlappingRendering(paramView)) {
          bool1 = modifiesAlpha(paramAnimation);
        }
      }
    }
    return bool1;
    ...
    for (;;)
    {
      ...
      if (paramFragment.mState > paramInt1) {
        ...
        case 2: 
          ...
          label1671:
          for (localObject2 = localObject3;; localObject2 = loadAnimation(paramFragment, paramInt2, false, paramInt3))
          {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\app\FragmentManagerImpl.class
