    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      if (ContainerHelpers.equal(((Map.Entry)paramObject).getKey(), MapCollections.this.colGetEntry(this.mIndex, 0))) {
        bool = ContainerHelpers.equal(((Map.Entry)paramObject).getValue(), MapCollections.this.colGetEntry(this.mIndex, 1));
      }
      return bool;
    }
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\lib\widget\recyclerview\MapCollections.class
