  ...
  extends Drawable
{
  ...
  public int getOpacity()
  {
    ...
    Bitmap localBitmap = this.mBitmap;
    if ((localBitmap == null) || (localBitmap.hasAlpha()) || (this.mPaint.getAlpha() < 255)) {}
    while (isGreaterThanZero(this.mCornerRadius)) {
      return -3;
    }
    return -1;
  }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\graphics\drawable\RoundedBitmapDrawable.class
