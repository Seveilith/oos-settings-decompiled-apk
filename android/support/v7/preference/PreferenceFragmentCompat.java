  ...
  implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment
{
  ...
  private Handler mHandler = new Handler()
  {
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      PreferenceFragmentCompat.-wrap0(PreferenceFragmentCompat.this);
    }
  };
  ...
  private final Runnable mRequestFocus = new Runnable()
  {
    public void run()
    {
      PreferenceFragmentCompat.-get0(PreferenceFragmentCompat.this).focusableViewAvailable(PreferenceFragmentCompat.-get0(PreferenceFragmentCompat.this));
    }
  };
  ...
  private void scrollToPreferenceInternal(final Preference paramPreference, final String paramString)
  {
    paramPreference = new Runnable()
    {
      public void run()
      {
        RecyclerView.Adapter localAdapter = PreferenceFragmentCompat.-get0(PreferenceFragmentCompat.this).getAdapter();
        ...
        {
          PreferenceFragmentCompat.-get0(PreferenceFragmentCompat.this).scrollToPosition(i);
          return;
        }
        localAdapter.registerAdapterDataObserver(new PreferenceFragmentCompat.ScrollToPreferenceObserver(localAdapter, PreferenceFragmentCompat.-get0(PreferenceFragmentCompat.this), paramPreference, paramString));
      }
    };
    if (this.mList == null)
    {
    ...
    extends RecyclerView.ItemDecoration
  {
    ...
    public void onDrawOver(Canvas paramCanvas, RecyclerView paramRecyclerView, RecyclerView.State paramState)
    {
      ...
      while (i < j)
      {
        ...
        {
          int m = (int)ViewCompat.getY(paramState) + paramState.getHeight();
    ...
    public void setDivider(Drawable paramDrawable)
    {
      ...
      for (this.mDividerHeight = paramDrawable.getIntrinsicHeight();; this.mDividerHeight = 0)
      {
        ...
        PreferenceFragmentCompat.-get0(PreferenceFragmentCompat.this).invalidateItemDecorations();
        return;
      }
    }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\preference\PreferenceFragmentCompat.class
