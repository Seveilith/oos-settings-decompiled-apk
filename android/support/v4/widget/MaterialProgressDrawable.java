  ...
  implements Animatable
{
  ...
  private void setupAnimators()
  {
    ...
    Animation local2 = new Animation()
    {
      public void applyTransformation(float paramAnonymousFloat, Transformation paramAnonymousTransformation)
      {
        ...
        MaterialProgressDrawable.this.setRotation(216.0F * paramAnonymousFloat + f1 * 1080.0F);
      }
    };
  ...
  {
    return (float)Math.toRadians(paramRing.getStrokeWidth() / (paramRing.getCenterRadius() * 6.283185307179586D));
  }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\widget\MaterialProgressDrawable.class
