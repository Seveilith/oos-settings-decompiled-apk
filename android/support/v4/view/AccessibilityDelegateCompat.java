      ...
      AccessibilityDelegateCompatJellyBean.newAccessibilityDelegateBridge(new AccessibilityDelegateCompatJellyBean.AccessibilityDelegateBridgeJellyBean()
      {
        ...
        public Object getAccessibilityNodeProvider(View paramAnonymousView)
        {
          ...
          if (localAccessibilityNodeProviderCompat != null) {
            paramAnonymousView = localAccessibilityNodeProviderCompat.getProvider();
          }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\view\AccessibilityDelegateCompat.class
