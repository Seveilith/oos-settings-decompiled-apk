...
class ChildHelper
{
  ...
  View findHiddenNonRemovedView(int paramInt1, int paramInt2)
  {
    ...
    if (i < j)
    {
      ...
      while ((paramInt2 != -1) && (localViewHolder.getItemViewType() != paramInt2))
      {
        i += 1;
        break;
      }
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\lib\widget\recyclerview\ChildHelper.class
