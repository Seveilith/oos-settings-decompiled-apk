...
public class DefaultAppTypeMusic
  extends DefaultAppTypeInfo
{
  public List<IntentFilter> getAppFilter()
  {
    ...
    try
    {
      localIntentFilter.addDataType("audio/*");
  ...
  public List<Intent> getAppIntent()
  {
    ...
    localIntent.setDataAndType(Uri.parse("content://"), "audio/*");
    localArrayList.add(localIntent);
    localIntent = new Intent("android.intent.action.VIEW");
    localIntent.addCategory("android.intent.category.DEFAULT");
    localIntent.setDataAndType(Uri.parse("file://"), "audio/*");
    localArrayList.add(localIntent);
    return localArrayList;
  }
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\settings\defaultapp\apptype\DefaultAppTypeMusic.class
