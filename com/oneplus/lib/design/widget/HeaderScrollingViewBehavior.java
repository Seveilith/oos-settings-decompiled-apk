  ...
  public boolean onMeasureChild(CoordinatorLayout paramCoordinatorLayout, View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((j == -1) || (j == -2))
    {
      ...
      if (localView != null)
      {
        ...
        {
          i = View.MeasureSpec.getSize(paramInt3);
          paramInt3 = i;
          if (i == 0) {
            paramInt3 = paramCoordinatorLayout.getHeight();
          }
          k = localView.getMeasuredHeight();
          m = getScrollRange(localView);
          if (j != -1) {
            break label143;
          }
        }
        label143:
        for (int i = 1073741824;; i = Integer.MIN_VALUE)
        {
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\lib\design\widget\HeaderScrollingViewBehavior.class
