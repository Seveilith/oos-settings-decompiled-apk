  ...
  implements MenuBuilder.ItemInvoker, MenuView
{
  ...
  static int measureChildForCells(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((paramView instanceof ActionMenuItemView))
    {
      ...
      bool = localActionMenuItemView.hasText();
      label50:
      paramInt4 = 0;
      paramInt3 = paramInt4;
      if (paramInt2 > 0) {
  ...
  private void onMeasureExactFormat(int paramInt1, int paramInt2)
  {
    ...
    while (i1 < i12)
    {
      ...
      else
      {
        ...
        if (bool)
        {
          bool = ((ActionMenuItemView)localObject).hasText();
  ...
  protected boolean hasSupportDividerBeforeChildAt(int paramInt)
  {
    ...
    if (paramInt < getChildCount())
    {
      ...
      if ((localView1 instanceof ActionMenuChildView)) {
        bool1 = ((ActionMenuChildView)localView1).needsDividerAfter();
      }
    }
    bool2 = bool1;
    if (paramInt > 0)
    ...
    implements MenuBuilder.Callback
  {
    ...
    public boolean onMenuItemSelected(MenuBuilder paramMenuBuilder, MenuItem paramMenuItem)
    {
      if (ActionMenuView.this.mOnMenuItemClickListener != null) {
        return ActionMenuView.this.mOnMenuItemClickListener.onMenuItemClick(paramMenuItem);
      }
      return false;
    }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\widget\ActionMenuView.class
