...
class FlowMonitor
{
  ...
  {
    if (this.mHitsGenerated < 50) {}
    for (;;)
    {
      return false;
      if (System.currentTimeMillis() - this.mLastQueryTimeStamp < 14400000L) {}
      for (int i = 1; i == 0; i = 0) {
        return true;
      }
    }
...
/* Location:              C:\Users\johan\Desktop\classes2-dex2jar.jar!\com\google\analytics\tracking\android\FlowMonitor.class
