  ...
  extends ViewGroup
{
  ...
  protected void onAttachedToWindow()
  {
    ...
    if (this.mWatchingAdapter != null) {
      localPagerAdapter = (PagerAdapter)this.mWatchingAdapter.get();
    }
    updateAdapter(localPagerAdapter, (PagerAdapter)localObject);
  }
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label34:
    for (float f = this.mLastKnownPositionOffset;; f = 0.0F)
    {
    ...
    implements ViewPager.OnPageChangeListener, ViewPager.OnAdapterChangeListener
  {
    ...
    public void onChanged()
    {
      ...
      for (float f = PagerTitleStrip.this.mLastKnownPositionOffset;; f = 0.0F)
      {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\view\PagerTitleStrip.class
