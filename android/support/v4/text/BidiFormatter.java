...
public final class BidiFormatter
{
  ...
  public static final class Builder
  {
    ...
    public Builder()
    {
      initialize(BidiFormatter.-wrap0(Locale.getDefault()));
    }
    
    public Builder(Locale paramLocale)
    {
      initialize(BidiFormatter.-wrap0(paramLocale));
    }
    ...
    {
      if (paramBoolean) {
        return BidiFormatter.-get1();
      }
      return BidiFormatter.-get0();
    }
    
    private void initialize(boolean paramBoolean)
    {
      this.mIsRtlContext = paramBoolean;
      this.mTextDirectionHeuristicCompat = BidiFormatter.-get2();
      this.mFlags = 2;
    }
    
    public BidiFormatter build()
    {
      if ((this.mFlags == 2) && (this.mTextDirectionHeuristicCompat == BidiFormatter.-get2())) {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\text\BidiFormatter.class
