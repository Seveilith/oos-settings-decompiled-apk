...
class ChildHelper
{
  ...
  View findHiddenNonRemovedView(int paramInt1, int paramInt2)
  {
    ...
    if (i < j)
    {
      ...
      if ((localViewHolder.getLayoutPosition() != paramInt1) || (localViewHolder.isInvalid())) {}
      while ((localViewHolder.isRemoved()) || ((paramInt2 != -1) && (localViewHolder.getItemViewType() != paramInt2)))
      {
        i += 1;
        break;
      }
  ...
  static class Bucket
  {
    ...
    void insert(int paramInt, boolean paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        if ((this.mData & 0x8000000000000000) != 0L)
        {
          ...
          this.mData = (this.mData & l | (this.mData & l) << 1);
          if (!paramBoolean) {
            break label105;
          }
          set(paramInt);
    ...
    boolean remove(int paramInt)
    {
      ...
      for (boolean bool = true;; bool = false)
      {
        this.mData &= l;
        l -= 1L;
        this.mData = (this.mData & l | Long.rotateRight(this.mData & l, 1));
        if (this.next != null)
        {
          if (this.next.get(0)) {
            set(63);
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v7\widget\ChildHelper.class
