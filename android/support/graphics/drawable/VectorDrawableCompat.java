  ...
  extends VectorDrawableCommon
{
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    int i;
    int j;
    for (Object localObject = this.mTintFilter;; localObject = this.mColorFilter)
    {
  ...
  public float getPixelSize()
  {
    ...
    while ((this.mVectorState.mVPathRenderer.mBaseWidth == 0.0F) || (this.mVectorState.mVPathRenderer.mBaseHeight == 0.0F) || (this.mVectorState.mVPathRenderer.mViewportHeight == 0.0F) || (this.mVectorState.mVPathRenderer.mViewportWidth == 0.0F)) {
      return 1.0F;
    }
    ...
    extends VectorDrawableCompat.VPath
  {
    ...
    public void inflate(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      ...
      paramResources = VectorDrawableCompat.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.styleable_VectorDrawableClipPath);
    ...
    extends VectorDrawableCompat.VPath
  {
    ...
    public void inflate(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      paramResources = VectorDrawableCompat.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.styleable_VectorDrawablePath);
  ...
  private static class VGroup
  {
    ...
    public void inflate(Resources paramResources, AttributeSet paramAttributeSet, Resources.Theme paramTheme, XmlPullParser paramXmlPullParser)
    {
      paramResources = VectorDrawableCompat.obtainAttributes(paramResources, paramTheme, paramAttributeSet, AndroidResources.styleable_VectorDrawableGroup);
      updateStateFromTypedArray(paramResources, paramXmlPullParser);
      paramResources.recycle();
    }
  ...
  private static class VPathRenderer
  {
    ...
    {
      VectorDrawableCompat.VGroup.-get1(paramVGroup).set(paramMatrix);
      VectorDrawableCompat.VGroup.-get1(paramVGroup).preConcat(VectorDrawableCompat.VGroup.-get0(paramVGroup));
      paramCanvas.save();
      int i = 0;
      if (i < paramVGroup.mChildren.size())
      {
        ...
        if ((paramMatrix instanceof VectorDrawableCompat.VGroup)) {
          drawGroupTree((VectorDrawableCompat.VGroup)paramMatrix, VectorDrawableCompat.VGroup.-get1(paramVGroup), paramCanvas, paramInt1, paramInt2, paramColorFilter);
        }
        for (;;)
        {
          i += 1;
    ...
    private void drawPath(VectorDrawableCompat.VGroup paramVGroup, VectorDrawableCompat.VPath paramVPath, Canvas paramCanvas, int paramInt1, int paramInt2, ColorFilter paramColorFilter)
    {
      ...
      paramVGroup = VectorDrawableCompat.VGroup.-get1(paramVGroup);
    ...
    extends Drawable.ConstantState
  {
    ...
    public VectorDrawableCompatState(VectorDrawableCompatState paramVectorDrawableCompatState)
    {
      if (paramVectorDrawableCompatState != null)
      {
        ...
        if (VectorDrawableCompat.VPathRenderer.-get0(paramVectorDrawableCompatState.mVPathRenderer) != null) {
          VectorDrawableCompat.VPathRenderer.-set0(this.mVPathRenderer, new Paint(VectorDrawableCompat.VPathRenderer.-get0(paramVectorDrawableCompatState.mVPathRenderer)));
        }
        if (VectorDrawableCompat.VPathRenderer.-get1(paramVectorDrawableCompatState.mVPathRenderer) != null) {
          VectorDrawableCompat.VPathRenderer.-set1(this.mVPathRenderer, new Paint(VectorDrawableCompat.VPathRenderer.-get1(paramVectorDrawableCompatState.mVPathRenderer)));
        }
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\graphics\drawable\VectorDrawableCompat.class
