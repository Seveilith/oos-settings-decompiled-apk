...
public class NotificationCompat
{
  ...
  public static class Builder
  {
    ...
    public Builder setLights(@ColorInt int paramInt1, int paramInt2, int paramInt3)
    {
      ...
      {
        Notification localNotification = this.mNotification;
        paramInt3 = this.mNotification.flags;
        paramInt2 = i;
        if (paramInt1 != 0) {
          paramInt2 = 1;
        }
        localNotification.flags = (paramInt2 | paramInt3 & 0xFFFFFFFE);
        return this;
      }
    }
    ...
    implements NotificationCompat.Extender
  {
    ...
    public CarExtender(Notification paramNotification)
    {
      ...
      for (paramNotification = (Notification)localObject;; paramNotification = NotificationCompat.getExtras(paramNotification).getBundle("android.car.EXTENSIONS"))
      {
    ...
    implements NotificationCompat.Extender
  {
    ...
    public WearableExtender(Notification paramNotification)
    {
      ...
      if (localBundle != null) {
        paramNotification = localBundle.getBundle("android.wearable.EXTENSIONS");
      }
      if (paramNotification != null)
      {
        localObject = NotificationCompat.IMPL.getActionsFromParcelableArrayList(paramNotification.getParcelableArrayList("actions"));
        if (localObject != null) {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\app\NotificationCompat.class
