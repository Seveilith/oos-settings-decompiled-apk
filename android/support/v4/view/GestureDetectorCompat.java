    ...
    implements GestureDetectorCompat.GestureDetectorCompatImpl
  {
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
        ...
        do
        {
          do
          {
            do
            {
              ...
              for (boolean bool1 = this.mDoubleTapListener.onDoubleTap(this.mCurrentDownEvent) | this.mDoubleTapListener.onDoubleTapEvent(paramMotionEvent);; bool1 = k)
              {
                this.mLastFocusX = f2;
                this.mDownFocusX = f2;
                this.mLastFocusY = f1;
            ...
            if (this.mIsDoubleTapping) {
              return this.mDoubleTapListener.onDoubleTapEvent(paramMotionEvent);
            }
      ...
      case 1: 
        ...
        if (this.mIsDoubleTapping) {
          bool2 = this.mDoubleTapListener.onDoubleTapEvent(paramMotionEvent);
        }
        for (;;)
        {
...
/* Location:              C:\Users\johan\Desktop\classes-dex2jar.jar!\android\support\v4\view\GestureDetectorCompat.class
