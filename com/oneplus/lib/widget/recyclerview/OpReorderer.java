...
class OpReorderer
{
  ...
  void swapMoveRemove(List<AdapterHelper.UpdateOp> paramList, int paramInt1, AdapterHelper.UpdateOp paramUpdateOp1, int paramInt2, AdapterHelper.UpdateOp paramUpdateOp2)
  {
    ...
    for (;;)
    {
      ...
      if (paramUpdateOp1.positionStart < paramUpdateOp2.positionStart + paramUpdateOp2.itemCount)
      {
        ...
        localUpdateOp = this.mCallback.obtainUpdateOp(1, paramUpdateOp1.positionStart + 1, k + m - n, null);
  ...
  void swapMoveUpdate(List<AdapterHelper.UpdateOp> paramList, int paramInt1, AdapterHelper.UpdateOp paramUpdateOp1, int paramInt2, AdapterHelper.UpdateOp paramUpdateOp2)
  {
    ...
    for (;;)
    {
      ...
      paramUpdateOp2.itemCount -= 1;
      localObject1 = this.mCallback.obtainUpdateOp(2, paramUpdateOp1.positionStart, 1, paramUpdateOp2.payload);
      break;
      label166:
      if (paramUpdateOp1.positionStart >= paramUpdateOp2.positionStart + paramUpdateOp2.itemCount) {
        break label54;
      ...
      localObject2 = this.mCallback.obtainUpdateOp(2, paramUpdateOp1.positionStart + 1, i, paramUpdateOp2.payload);
...
/* Location:              C:\Users\johan\Desktop\dex2jar-2.0\classes3-dex2jar.jar!\com\oneplus\lib\widget\recyclerview\OpReorderer.class
