  ...
  implements ResolvedRuleBuilder
{
  ...
  public static Debug.ResolvedFunctionCall translateExpandedFunctionCall(ResourceUtil.ExpandedFunctionCall paramExpandedFunctionCall)
  {
    ...
    for (;;)
    {
      if (!paramExpandedFunctionCall.hasNext()) {
    ...
    implements ResolvedFunctionCallTranslatorList
  {
    ...
    public void translateAndAddAll(List<ResourceUtil.ExpandedFunctionCall> paramList, List<String> paramList1)
    {
      ...
      default: 
        ...
        for (((Debug.ResolvedFunctionCall)localArrayList.get(i)).associatedRuleName = "Unknown";; ((Debug.ResolvedFunctionCall)localArrayList.get(i)).associatedRuleName = ((String)paramList1.get(i)))
        {
          i += 1;
          break;
        }
...
/* Location:              C:\Users\johan\Desktop\classes2-dex2jar.jar!\com\google\tagmanager\DebugResolvedRuleBuilder.class
